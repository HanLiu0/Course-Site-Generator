...
public class AppNodesBuilder {
    ...
    public TableView buildTableView(Object nodeId,
        ...
        tableView.setPlaceholder(placeHolderLbl);
        languageSettings.addLabeledControlProperty(nodeId.toString() + "_TEXT", placeHolderLbl.textProperty());
        // INITIALIZE THE OTHER SETTINGS
    ...
    public RadioButton buildRB(Object nodeId,
            HBox hBox,
            ToggleGroup tgTA,
            String styleClass,
            boolean enabled){
        RadioButton rb = new RadioButton();
        languageSettings.addLabeledControlProperty(nodeId.toString() + "_TEXT", rb.textProperty());
